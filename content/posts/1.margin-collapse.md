...
![](/img/margin-collapse/compare.png)
...
![父子元素间的外边距合并](/img/margin-collapse/parent-child-collapse.png)
...
![同级元素间的外边距合并](/img/margin-collapse/sibling-collapse.png)
...
![空的块元素自身的外边距合并](/img/margin-collapse/self-collapse.png)
